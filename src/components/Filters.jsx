...
const Filters = ({ filterId, filterHeader, filterContents, updateFilters }) => {
  ...
  return (
    <div className="filters" id={filterId}>
      <div className="selected-filter" onClick={() => setOpen(!open)}>
        <div className="selected-filter-text">
          {selectedFilter ? selectedFilter : filterHeader}
        </div>
        <FaCaretDown
          className={
            open
              ? "filter-caret filter-down-caret hide"
              : "filter-caret filter-down-caret"
          }
        />
        <FaCaretUp
          className={
            open
              ? "filter-caret filter-up-caret"
              : "filter-caret filter-up-caret hide"
          }
        />
      </div>
